<div class="col-lg-3 col-md-6 col-sm-6 flex-item-plan">
    <div class="card card-stats">
        <div class="card-header <?php echo e($color); ?> card-header-icon" data-header-animation="true">
            <div class="card-icon">
...
<!--            <h3 class="card-title card-title-plan"><?php echo e($name); ?> <br> Service </h3>-->
            <h3 class="card-title card-title-plan"> <?php echo nl2br($description); ?> </h3>
        </div>
